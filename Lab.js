...
function plus1(){
  ...
  function cal(){
    ...
    var counter3 = Number(document.getElementById("result3").innerText);
    var counter4 = Number(document.getElementById("result4").innerText);
    var sum1 = 200000*counter1;
    var sum2 = 500000*counter2;
    var sum3 = 300000*counter3;
    var sum4 = 800000*counter4;
    var rsum = sum1+sum2+sum3+sum4;
    var sumc = counter1+counter2+counter3+counter4;
    var text1 = (document.getElementById("a1").innerText);
    var text2 = (document.getElementById("a2").innerText);
    var text3 = (document.getElementById("a3").innerText);
    var text4 = (document.getElementById("a4").innerText);
